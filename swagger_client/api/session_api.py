...
class SessionApi(object):
    ...
    def create_charge_session(self, **kwargs):    # noqa: E501
        ...
        >>> thread = api.create_charge_session(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CreateChargeSession body:
        :return: Session
    ...
    def create_charge_session_with_http_info(self, **kwargs):    # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_charge_session_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_charge_session" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def create_recurring_session(self, **kwargs):    # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_recurring_session(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CreateRecurringSession body:
        :return: Session
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def create_recurring_session_with_http_info(self, **kwargs):    # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_recurring_session_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_recurring_session" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def create_subscription_session(self, **kwargs):    # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_subscription_session(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CreateSubscriptionSession body:
        :return: Session
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def create_subscription_session_with_http_info(self, **kwargs):    # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_subscription_session_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_subscription_session" % key
                )
            params[key] = val
        del params['kwargs']
